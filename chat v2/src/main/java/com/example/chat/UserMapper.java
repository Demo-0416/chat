...
public interface UserMapper {
    ...
    @Select("SELECT `gptResponseHistory` from dialogue where dialogueId = #{id}")
    ...
    @Select("select * from content where lawName like CONCAT('%',#{name},'%')")
    List<Content> findLawByName(@Param("name") String name);

    @Select("select * from content where lawName like CONCAT('%',#{name},'%') and lawExplain like CONCAT('%',#{explain},'%')")
    ...
    @Select("select * from content where lawName like CONCAT('%',#{name},'%') and lawContent like  CONCAT('%', #{lawContent}, '%')")
    List<Content> findLawsByContentAndName(@Param("name") String name, @Param("lawContent") String content);

    @Select("select * from content where lawName like CONCAT('%',#{name},'%') and lawContent like CONCAT('%', #{lawContent}, '%') and lawExplain like CONCAT('%',#{explain},'%')")
